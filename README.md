...
Web app buat admin generate invoice DP / Final Payment untuk Melanao & Omoji,
...
## Cara pakai
1. Pilih Brand, lalu **Jenis Dokumen**: Quotation atau Invoice (kalau Invoice, pilih lagi DP / Final Payment).
...
### Nyambungin Quotation → Invoice DP → Invoice Final Payment
...
Tiap baris di Daftar Invoice ada tombol aksi sesuai status-nya sekarang:
